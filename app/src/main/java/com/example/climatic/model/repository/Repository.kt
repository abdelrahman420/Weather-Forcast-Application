...
interface Repository {
    ...
    suspend fun _getCurrentWeatherByCity(city: String, apiKey: String, units: String = "metric"): Flow<WeatherResponse>
    suspend fun _getCurrentWeatherByLatLon(lat: Double, lon: Double, apiKey: String, units: String = "metric"): Flow<WeatherResponse>
    suspend fun _getWeatherForecastByCity(city: String, apiKey: String, units: String = "metric"): Flow<ForecastResponse>
    suspend fun _getWeatherForecastByLatLon(lat: Double, lon: Double, apiKey: String, units: String = "metric"): Flow<ForecastResponse>
